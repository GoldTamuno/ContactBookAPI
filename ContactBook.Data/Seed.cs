...
namespace ContactBook.Data
{
    public class Seed
    {
        public static async Task SeedData(ContactDbContext context, UserManager<AppUser> userManager, RoleManager<IdentityRole> roleManager)
        {
        ...
        private static async Task SeedUsers(UserManager<AppUser> userManager, ContactDbContext context)
        {
